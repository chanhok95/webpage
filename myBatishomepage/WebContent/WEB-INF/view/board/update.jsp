...
<h3>
	...
	<div align="center" style="margin: 0px 0px 0px 450px;"><a href="${root }/board/list.do">글목록</a></div>
	<div class="content">
		<form method="post"	action ="${root }/board/updateOk.do" onsubmit="return boardForm(this)">
